...
如果使用者有填寫健康限制 / 身體狀況，請把它視為安全邊界：不要做醫療診斷、不要宣稱治療疾病、不要替代醫師建議；若提到醫師交代事項，提醒以專業醫療意見為優先。
若健康限制包含尿酸管理，避免過度推薦高普林食物；若包含血脂偏高，避免高油、高飽和脂肪、炸物；若包含血壓需注意，提醒控制鈉、加工食品與重鹹湯底；若包含肝功能曾異常，避免鼓勵酒精、高油暴食。
可以說「根據你填寫的健康限制，這餐建議避開...」，但不要推斷使用者有未明確填寫的疾病。
...
如果使用者有填寫健康限制 / 身體狀況，請把它視為安全邊界：不要宣稱治療疾病、不要替代醫師建議；若提到醫師交代事項，提醒以專業醫療意見為優先。
若健康限制包含尿酸管理，避免過度推薦高普林食物；若包含血脂偏高，避免高油、高飽和脂肪、炸物；若包含血壓需注意，提醒控制鈉、加工食品與重鹹湯底；若包含肝功能曾異常，避免鼓勵酒精、高油暴食。
"""
    prompt += format_meal_context(coach_context)
